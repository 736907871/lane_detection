...
class parsingNet(torch.nn.Module):
    def __init__(self, size=(288, 800), pretrained=True, backbone='50', cls_dim=(37, 10, 4), use_aux=False):
        ...
        # print('---use_aux---:{}'.format(self.use_aux))
        if self.use_aux:
    ...
    def forward(self, x):
        ...
        # print('\nx2:{}, \nx3:{}, \nfea:{}'.format(x2.shape, x3.shape, fea.shape))
        """
        x2:torch.Size([32, 128, 36, 100]), 
        x3:torch.Size([32, 256, 18, 50]), 
        fea:torch.Size([32, 512, 9, 25])
        """
        if self.use_aux:
